...
export default function RootLayout({ children }) {
  ...
  <html>
    ...
    <div id='homepage2' class=" container list-item sm:grid grid-cols-6 gap-x-2 gap-y-3 m-auto px-4">
      ...
      <div className='bg-black/70 rounded-lg shadow-xl min-h[50px] col-span-2 row-span-1 hidden sm:block'><Sugesstions /></div>
      <div className='bg-black/40 rounded-lg shadow-xl col-span-2 row-span-1 hidden sm:block'><Gifts /></div>
